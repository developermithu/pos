...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'zihadplastic2024@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hello@example.com'),
                'name' => env('MAIL_FROM_NAME', 'Zihad Plastic'),
            ],
        ],

        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',

            /*
             * If this is set to null the default channel of the webhook will be used.
             */
            'channel' => '#zihad-plastic',

            'username' => 'developermithu',
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => 2500, // 2.5 GB
        ],
