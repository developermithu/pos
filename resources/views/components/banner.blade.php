    ...
    <div class="flex items-center justify-between w-full h-full px-3 mx-auto max-w-7xl ">
        <a
            ...
            <span class="flex items-center">
                ...
                <strong class="font-semibold"> {{ __('New Feature') }} </strong>
                <span class="hidden w-px h-4 mx-3 rounded-full bg-black/20 sm:block"></span>
            </span>
            <span class="block pt-1 pb-2 leading-none sm:inline sm:pt-0 sm:pb-0">
                {{ __('Application is under maintenance.') }}
            </span>
        </a>
