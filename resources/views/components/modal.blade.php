@props(['name', 'show' => false, 'maxWidth' => '2xl', 'align' => 'center'])
...
@php
    ...
    switch ($align) {
        case 'top':
            $alignmentClasses = 'flex items-start justify-center';
            break;

        case 'center':
        default:
            $alignmentClasses = 'flex items-center justify-center';
            break;
    }
@endphp
...
<div x-data="{
    ...
    class="fixed inset-0 z-50 {{ $alignmentClasses }} px-4 py-6 overflow-y-auto sm:px-0"
