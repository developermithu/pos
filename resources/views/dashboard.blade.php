<x-app-layout>
    <div class="px-4 py-6 space-y-6">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
                ...
                <div class="items-center sm:flex">
                    <div class="flex items-center">
                        ...
                        <div id="dropdown" class="z-10 hidden w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(887.2px, 3078.4px, 0px);"
            ...
            <div class="flex items-center justify-between pt-3 sm:pt-6">
                <div>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(354.4px, 3045.6px, 0px);"
