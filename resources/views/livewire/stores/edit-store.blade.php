<div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
    <div class="flex flex-col mb-4 col-span-full md:flex-row md:items-center md:justify-between xl:mb-2">
        <x-breadcrumb>
            <x-breadcrumb.item :label="__('stores')" :href="route('admin.stores.index')" />
        ...
        <div
            ...
            <form wire:submit="save">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <x-input.group for="location" :label="__('location')" :error="$errors->first('form.location')" class="sm:col-span-full">
                        <x-input wire:model="form.location" id="location" required />
                    </x-input.group>
